...
##-------------------start-of-__init__()--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def __init__(self, inc_member_id:int, inc_member_name:str, inc_spin_scores:typing.Tuple[int,int,int], inc_owned_card_ids:typing.List[int], inc_credits:int) -> None:
        ...
        self.spin_scores: typing.Tuple[int,int,int] = inc_spin_scores
